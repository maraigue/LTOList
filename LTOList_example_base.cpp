...
int main(void){
	...
	ot.display_tree(std::cout); std::cout << std::endl;
	...
	std::cout << "----------------------------" << std::endl;
	std::cout << "Random access (size == " << ot.size() << ")" << std::endl;
	std::cout << "----------------------------" << std::endl;
	...
	while(ot.size() > 0){
		...
		std::cout << std::endl;
		std::cout << "REMOVING " << removing << " -- next_to_removed " << next_to_removed << std::endl;
		std::cout << "========================================================" << std::endl;
	}
}
